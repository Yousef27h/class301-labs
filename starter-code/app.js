...
// it's referring to object instance which is "joe" in this case
// 2. What is "this" when joe.scopeArrow() is invoked?
// it's referring to object of the containing element, which is in this case "window" object
// 3. Explain why "this" is different when an arrow function is used.
//  because in arrow function it refers to the containing element scope not the scope we created inside the object.